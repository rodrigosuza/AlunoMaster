          ...
          <div className="bg-white p-4 md:p-6 rounded-[24px] shadow-sm border border-slate-100 flex flex-col max-h-[180px] lg:max-h-full lg:h-full overflow-hidden">
            ...
            <div className="space-y-1 overflow-y-auto custom-scrollbar pr-1 flex-1 min-h-0">
              <button
                ...
                className={`w-full flex items-center justify-between p-2.5 md:p-3.5 rounded-xl md:rounded-[18px] transition-all font-bold text-xs md:text-sm ${activeFolderId === 'all'
              ...
              <button
                ...
                className={`w-full flex items-center justify-between p-2.5 md:p-3.5 rounded-xl md:rounded-[18px] transition-all font-bold text-xs md:text-sm ${activeFolderId === 'favorites'
              ...
              {folders.map(folder => (
                <button
                  ...
                  className={`w-full flex items-center justify-between p-2.5 md:p-3.5 rounded-xl md:rounded-[18px] transition-all font-bold text-xs md:text-sm ${activeFolderId === folder.id
                      ? 'bg-indigo-600 text-white shadow-lg shadow-indigo-100'
                      : 'text-slate-500 hover:bg-slate-50 hover:text-slate-900'
                    }`}
                >
                  ...
                  {menuOpenId === session.id && (
                    <div className="absolute right-0 top-full mt-2 w-48 bg-white rounded-xl shadow-xl border border-slate-100 z-20 overflow-hidden animate-in fade-in zoom-in-95 duration-200">
                      ...
                      <button
                        ...
                        className="w-full flex items-center gap-2 px-3 py-2 text-xs md:text-sm font-bold text-red-500 hover:bg-red-50 rounded-lg mb-1"
                      >
